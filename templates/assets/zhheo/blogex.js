...
//         function () {
//             // 鼠标移出时执行以下代码
//             console.log("Mouse left the topGroup area");
//             hoverOnCommentBarrage = false; // 重置变量
//             const topGroupElement = document.getElementById("topGroup");
//             if (topGroupElement) {
//                 topGroupElement.classList.remove("hideCard"); // 移除 hideCard 类
//                 topGroupElement.style.zIndex = 1; // 设置 z-index
//             } else {
//                 console.error("Element with ID 'topGroup' not found");
//             }
//         }
//     );
// }
